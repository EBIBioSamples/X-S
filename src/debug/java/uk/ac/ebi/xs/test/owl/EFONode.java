...
public class EFONode
{
    ...
    private final SortedSet<EFONode> children = new TreeSet<EFONode>(TERM_COMPARATOR);
    private final SortedSet<EFONode> parents = new TreeSet<EFONode>(TERM_COMPARATOR);
